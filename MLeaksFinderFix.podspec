...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MLeaksFinderFix.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/heyunqian/MLeaksFinderFix'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'heyunqian' => '1670912199@qq.com' }
  s.source           = { :git => 'https://github.com/heyunqian/MLeaksFinderFix.git', :tag => s.version.to_s }
